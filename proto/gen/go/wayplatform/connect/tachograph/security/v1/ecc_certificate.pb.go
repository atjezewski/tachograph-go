...
// 	protoc        (unknown)
// source: wayplatform/connect/tachograph/security/v1/ecc_certificate.proto
...
func (x *EccCertificate) Reset() {
	*x = EccCertificate{}
	mi := &file_wayplatform_connect_tachograph_security_v1_ecc_certificate_proto_msgTypes[0]
...
func (x *EccCertificate) GetCertificateAuthorityReference() string {
	if x != nil {
...
func (x *EccCertificate) GetCertificateHolderReference() string {
	if x != nil {
...
func (x *EccCertificate_PublicKey) Reset() {
	*x = EccCertificate_PublicKey{}
	mi := &file_wayplatform_connect_tachograph_security_v1_ecc_certificate_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *EccCertificate_EccSignature) Reset() {
	*x = EccCertificate_EccSignature{}
	mi := &file_wayplatform_connect_tachograph_security_v1_ecc_certificate_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_wayplatform_connect_tachograph_security_v1_ecc_certificate_proto protoreflect.FileDescriptor
...
const file_wayplatform_connect_tachograph_security_v1_ecc_certificate_proto_rawDesc = "" +
	...
	" certificate_holder_authorisation\x18\x03 \x01(\fR\x1ecertificateHolderAuthorisation\x12c\n" +
	"\n" +
	"public_key\x18\x04 \x01(\v2D.wayplatform.connect.tachograph.security.v1.EccCertificate.PublicKeyR\tpublicKey\x12@\n" +
	"\x1ccertificate_holder_reference\x18\x05 \x01(\tR\x1acertificateHolderReference\x12X\n" +
	"\x1acertificate_effective_date\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\x18certificateEffectiveDate\x12Z\n" +
	"\x1bcertificate_expiration_date\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\x19certificateExpirationDate\x12e\n" +
	...
	"\x01s\x18\x02 \x01(\fR\x01sB\xfc\x02\n" +
	".com.wayplatform.connect.tachograph.security.v1B\x13EccCertificateProtoP\x01Zhgithub.com/way-platform/tachograph-go/proto/gen/go/wayplatform/connect/tachograph/security/v1;securityv1\xa2\x02\x04WCTS\xaa\x02*Wayplatform.Connect.Tachograph.Security.V1\xca\x02*Wayplatform\\Connect\\Tachograph\\Security\\V1\xe2\x026Wayplatform\\Connect\\Tachograph\\Security\\V1\\GPBMetadata\xea\x02.Wayplatform::Connect::Tachograph::Security::V1b\beditionsp\xe8\a"

var file_wayplatform_connect_tachograph_security_v1_ecc_certificate_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_wayplatform_connect_tachograph_security_v1_ecc_certificate_proto_goTypes = []any{
	(*EccCertificate)(nil),              // 0: wayplatform.connect.tachograph.security.v1.EccCertificate
	(*EccCertificate_PublicKey)(nil),    // 1: wayplatform.connect.tachograph.security.v1.EccCertificate.PublicKey
	(*EccCertificate_EccSignature)(nil), // 2: wayplatform.connect.tachograph.security.v1.EccCertificate.EccSignature
	(*timestamppb.Timestamp)(nil),       // 3: google.protobuf.Timestamp
}
var file_wayplatform_connect_tachograph_security_v1_ecc_certificate_proto_depIdxs = []int32{
	1, // 0: wayplatform.connect.tachograph.security.v1.EccCertificate.public_key:type_name -> wayplatform.connect.tachograph.security.v1.EccCertificate.PublicKey
	3, // 1: wayplatform.connect.tachograph.security.v1.EccCertificate.certificate_effective_date:type_name -> google.protobuf.Timestamp
	3, // 2: wayplatform.connect.tachograph.security.v1.EccCertificate.certificate_expiration_date:type_name -> google.protobuf.Timestamp
	2, // 3: wayplatform.connect.tachograph.security.v1.EccCertificate.signature:type_name -> wayplatform.connect.tachograph.security.v1.EccCertificate.EccSignature
...
func init() { file_wayplatform_connect_tachograph_security_v1_ecc_certificate_proto_init() }
func file_wayplatform_connect_tachograph_security_v1_ecc_certificate_proto_init() {
	if File_wayplatform_connect_tachograph_security_v1_ecc_certificate_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wayplatform_connect_tachograph_security_v1_ecc_certificate_proto_rawDesc), len(file_wayplatform_connect_tachograph_security_v1_ecc_certificate_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_wayplatform_connect_tachograph_security_v1_ecc_certificate_proto_goTypes,
		DependencyIndexes: file_wayplatform_connect_tachograph_security_v1_ecc_certificate_proto_depIdxs,
		MessageInfos:      file_wayplatform_connect_tachograph_security_v1_ecc_certificate_proto_msgTypes,
	}.Build()
	File_wayplatform_connect_tachograph_security_v1_ecc_certificate_proto = out.File
	file_wayplatform_connect_tachograph_security_v1_ecc_certificate_proto_goTypes = nil
	file_wayplatform_connect_tachograph_security_v1_ecc_certificate_proto_depIdxs = nil
}
